...
For the default Patchright backend, `doctor` also reports installed version,
release pin, and npm latest when network checks are enabled.
...
--backend <name>         # Local Chrome backend: patchright (default), chrome
