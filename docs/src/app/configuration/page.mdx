...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>AGENT_BROWSER_PATCHRIGHT_CHANNEL</code></td><td>Browser channel for the optional <a href="/providers/patchright">Patchright provider</a>.</td><td><code>chrome</code></td></tr>
    <tr><td><code>AGENT_BROWSER_PATCHRIGHT_RUNTIME_DIR</code></td><td>Private supervisor state directory for the optional Patchright provider.</td><td><code>~/.agent-browser/providers/patchright</code></td></tr>
    <tr><td><code>AGENT_BROWSER_PATCHRIGHT_MAX_LIFETIME_MS</code></td><td>Forced Patchright provider lifetime, bounded from one minute through seven days.</td><td>One day</td></tr>
