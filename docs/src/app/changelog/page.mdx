...
<p className="text-[#888] text-sm">July 5, 2026</p>
...
<p className="text-[#888] text-sm">June 18, 2026</p>

### Improvements

- Updated the default Patchright backend pin from 1.60.2 to 1.61.0.
- Added `agent-browser doctor` reporting for installed Patchright version, release pin, and npm latest when network checks are enabled.
